...
export default {
    ...
    const popover_helpers = [
 {
  ...
  description: "The column name in your .csv file that contains the names of the variables."
},
{
  name: "Definition column name",
  description: "The column name in your .csv file that contains descriptions of each variable."
},
{
  name: "Delimiter",
  description: "The delimiter used to separate entries in your .csv file."
},
{
  name: "K (Number of candidates)",
  description: "The number of candidates generated by the AI-based model. While more candidates may enhance prediction accuracy, they also lead to an increase in computational time. The recommended number of candidates is K=5."
},
{
  name: "Return all mappings",
  description: "If set to true, all known mappings onto the predicted target variable will be returned. If set to false, only the target variable will be returned."
},
{
  name: "W1 (AI-based model)",
  description: "The weight of the AI-based model. The final class probability will be determined by (W1 * AI-based model) + (W2 * string matching)."
},
{
  name: "W2 (String matching)",
  description: "The weight of the string matching algorithm. The final class probability will be determined by (W1 * AI-based model) + (W2 * string matching)."
}
