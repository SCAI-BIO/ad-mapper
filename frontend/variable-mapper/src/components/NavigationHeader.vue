<template>
    <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 py-2 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                <div class="flex items-center px-2 lg:px-0">
                    <div class="flex-shrink-0 grid place-items-center">

                        <img class="block h-16 w-auto" :src="logoPath"
                            alt="Workflow" />
                    </div>
                    <div class="hidden lg:block lg:ml-6">
                        <div class="flex space-x-4">
                            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/">Home</router-link>
                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/how-it-works">Playground</router-link>

                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/upload">Map a CSV</router-link>
                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/cdm">CDM</router-link>
                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/contact">Contact</router-link>
                            <router-link class="text-gray-50 hover:bg-gray-700 hover:text-whit text-white px-3 py-2 rounded-md text-xl font-medium" to="/news">News</router-link>
        ...
        <DisclosurePanel class="lg:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <DisclosureButton as="a" href="#"
                    class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Dashboard
                </DisclosureButton>
                <DisclosureButton as="a" href="#"
...
export default {
    components: { Disclosure, DisclosureButton, DisclosurePanel, BellIcon, MenuIcon, XIcon }, 
    data() {
        return {
            logoPath: process.env.BASE_URL + "logo.png"
        }
    }
}
